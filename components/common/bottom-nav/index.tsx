    ...
    return (
        <View className="bg-white border-2 border-gray-100 shadow-md mx-6 w-[90%] h-20 rounded-full absolute items-center justify-around bottom-6 z-50 flex flex-row py-2">
            ...
            <TouchableNativeFeedback onPress={() => navigation.navigate("/album")}> 
                <View className={`rounded-full p-3.5 ${pathname === "/album" ? "bg-blue-500" : "bg-transparent"}`}>
            ...
            <TouchableNativeFeedback onPress={() => navigation.navigate("/month")}> 
                <View className={`rounded-full p-3.5 ${pathname === "/month" ? "bg-blue-500" : "bg-transparent"}`}>
